...
class SearchPage(BasePage):
    ...
    def __init__(self, page: Page):
        ...
        self.priceMinDropdown = self.priceMenu.locator('.SearchTopBarFilters__DropdownRangeMin')
        self.priceMaxLabel = self.priceMenu.locator('[id^=right-label-]')
        self.priceMaxDropdown = self.priceMenu.locator('.SearchTopBarFilters__DropdownRangeMax')
        ...
        self.propertyTypeCheckboxLabel = self.propertyTypeCheckbox.locator('.Checkbox__CheckboxLabel')
